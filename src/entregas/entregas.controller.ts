...
@Post()
  ...
  @ApiResponse({ status: 200, description: 'Lista de entregas', type: [Entrega] })
  ...
  @ApiResponse({ status: 200, description: 'Entrega encontrada', type: Entrega })
  ...
  @ApiResponse({ status: 200, description: 'Entrega actualizada', type: Entrega })
  @ApiResponse({ status: 404, description: 'Entrega no encontrada' })
